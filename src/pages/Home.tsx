    ...
    <div className="mx-auto max-w-6xl px-4 py-12 sm:py-16">
      <section className="mb-12 max-w-2xl">
        ...
        <p className="mt-4 text-lg text-muted-foreground">
          Живые примеры компонентов shadcn/ui с разбором по-русски: что это, чем
          отличается от соседних и как ведёт себя на практике. Выбирай компонент
          в меню сверху или из карточек ниже.
        </p>
      </section>
      ...
      <section className="mb-12 max-w-2xl">
        ...
        <p className="mt-2 text-muted-foreground">
          Вайбкодинг начинается с промпта. Дай его ассистенту (Claude Code,
