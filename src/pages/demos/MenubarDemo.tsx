    ...
    <div className="mx-auto max-w-4xl px-4 py-12">
      <header className="mb-8">
        ...
        <p className="mt-2 text-muted-foreground">
          ...
          несколько меню в ряд, между которыми удобно ходить мышью и с
          клавиатуры.
        </p>
      </header>
      ...
      <Card className="mb-8">
        <CardHeader>
          ...
          <CardDescription>
            Несколько меню работают согласованно — это чуть сложнее одиночного
            выпадающего меню.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <ul className="list-disc space-y-1 pl-5 text-sm text-muted-foreground">
            ...
            <li>
              Управление с клавиатуры: стрелки между меню и пунктами, переход к
              пункту по первым буквам, Esc — закрыть.
            </li>
            <li>
