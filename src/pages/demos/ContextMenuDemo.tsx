    ...
    <div className="mx-auto max-w-4xl px-4 py-12">
      <header className="mb-8">
        ...
        <p className="mt-2 text-muted-foreground">
          Меню по правому клику — как в проводнике и десктоп-приложениях. Та же
          механика Radix, что у Dropdown/Menubar, но открывается контекстно.
        </p>
      </header>
      ...
      <Card className="mb-8">
        ...
        <CardContent>
          <ul className="list-disc space-y-1 pl-5 text-sm text-muted-foreground">
            <li>
              Открывается по правому клику (событие contextmenu) на любой
              обёрнутой области.
            </li>
            <li>
              Поведение и доступность — как у обычного меню: клавиатура, фокус,
              ARIA, портал.
            </li>
            <li>
              Те же богатые пункты: подменю, разделители, горячие клавиши,
              чекбоксы, радио, метки, destructive.
            </li>
          </ul>
        </CardContent>
      </Card>
