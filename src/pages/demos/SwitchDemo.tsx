    ...
    <div className="mx-auto max-w-4xl px-4 py-12">
      <header className="mb-8">
        ...
        <p className="mt-2 text-muted-foreground">
          Переключатель «вкл/выкл» — бинарный тумблер для настроек, которые
          применяются сразу. На Radix, с клавиатурой и доступностью.
        </p>
      </header>
        ...
        <CardContent>
          <ul className="list-disc space-y-1 pl-5 text-sm text-muted-foreground">
            <li>
              ...
              выбор, который подтверждается позже кнопкой (в форме).
            </li>
            <li>
              <strong>Контролируемый:</strong> <code>checked</code> /{" "}
              <code>onCheckedChange</code> — булево значение.
            </li>
            <li>
              <strong>Доступность:</strong> роль <code>switch</code>,{" "}
              <code>aria-checked</code>, связь с <code>Label</code> через{" "}
              <code>htmlFor</code> / <code>id</code>; переключается пробелом.
            </li>
          </ul>
        </CardContent>
      </Card>
